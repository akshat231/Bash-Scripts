...
# --- Run Scholar Snap Backend ---
cd "${CURRENT_DIR}/../../scholar-snap/scholar_snap_backend"
log INFO "Starting scholar-snap-backend..."
sudo docker-compose -f docker-compose.yml --compatibility up --build -d

# --- Run Sequelize migrations ---
log INFO "Running Sequelize migrations..."
if ! sudo docker exec scholar-snap-backend npx sequelize db:migrate; then
...
log INFO "Starting scholar-snap-ai..."
sudo docker-compose -f docker-compose.yml --compatibility up --build -d
